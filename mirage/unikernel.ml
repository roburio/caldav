...
module Main (C : Mirage_console.S) (R : Mirage_random.S) (T : Mirage_time.S) (Clock: Mirage_clock.PCLOCK) (_ : sig end) (S: Cohttp_mirage.Server.S) (Zap : Mirage_kv.RO) (Management : Mirage_stack.V4V6) = struct
